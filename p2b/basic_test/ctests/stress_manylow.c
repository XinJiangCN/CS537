...
main(int argc, char *argv[])
{
   ...
   pipe(pipe_par);
   pipe(pipe_chd);
   printf(1,"Goal: Achieve <5% error in tick difference between a single high ticket process and many low ticket processes\n");
   ...
   if (lowdiff < 5){
     printf(1,"check failed: Expected the process with low tickets to run\n");
     goto Cleanup;
   }
